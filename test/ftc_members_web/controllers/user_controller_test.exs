defmodule FtcMembersWeb.UserControllerTest do
  use FtcMembersWeb.ConnCase

  alias FtcMembers.Accounts

  @create_attrs %{bnet_id: "some bnet_id", name: "some name", username: "some username"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated bnet_id"
    end
